...
var file_comm_proto_goTypes = []any{
	(*FileInfoMsg)(nil),           // 0: remotefscomms.FileInfoMsg
	(*UintMsg)(nil),               // 1: remotefscomms.UintMsg
	(*ContentMsg)(nil),            // 2: remotefscomms.ContentMsg
	(*SetInfoParamsMsg)(nil),      // 3: remotefscomms.SetInfoParamsMsg
	(*MkInodeMsg)(nil),            // 4: remotefscomms.MkInodeMsg
	(*Empty)(nil),                 // 5: remotefscomms.Empty
	nil,                           // 6: remotefscomms.FileInfoMsg.ChildrenIndexMapEntry
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_comm_proto_depIdxs = []int32{
	6,  // 0: remotefscomms.FileInfoMsg.childrenIndexMap:type_name -> remotefscomms.FileInfoMsg.ChildrenIndexMapEntry
	7,  // 1: remotefscomms.FileInfoMsg.atime:type_name -> google.protobuf.Timestamp
	7,  // 2: remotefscomms.FileInfoMsg.mtime:type_name -> google.protobuf.Timestamp
	7,  // 3: remotefscomms.FileInfoMsg.ctime:type_name -> google.protobuf.Timestamp
	7,  // 4: remotefscomms.FileInfoMsg.crtime:type_name -> google.protobuf.Timestamp
	7,  // 5: remotefscomms.SetInfoParamsMsg.atime:type_name -> google.protobuf.Timestamp
	7,  // 6: remotefscomms.SetInfoParamsMsg.mtime:type_name -> google.protobuf.Timestamp
	5,  // 7: remotefscomms.RemoteFSComms.GetSizeComm:input_type -> remotefscomms.Empty
	5,  // 8: remotefscomms.RemoteFSComms.GetLengthComm:input_type -> remotefscomms.Empty
	1,  // 9: remotefscomms.RemoteFSComms.GetInfoComm:input_type -> remotefscomms.UintMsg
	3,  // 10: remotefscomms.RemoteFSComms.SetInfoComm:input_type -> remotefscomms.SetInfoParamsMsg
	1,  // 11: remotefscomms.RemoteFSComms.DeleteComm:input_type -> remotefscomms.UintMsg
	4,  // 12: remotefscomms.RemoteFSComms.MkDirComm:input_type -> remotefscomms.MkInodeMsg
	1,  // 13: remotefscomms.RemoteFSComms.GenerateHandleComm:input_type -> remotefscomms.UintMsg
	4,  // 14: remotefscomms.RemoteFSComms.CreateFileComm:input_type -> remotefscomms.MkInodeMsg
	1,  // 15: remotefscomms.RemoteFSComms.RmDirComm:input_type -> remotefscomms.UintMsg
	1,  // 16: remotefscomms.RemoteFSComms.DeleteHandleComm:input_type -> remotefscomms.UintMsg
	1,  // 17: remotefscomms.RemoteFSComms.SyncFileComm:input_type -> remotefscomms.UintMsg
	2,  // 18: remotefscomms.RemoteFSComms.WriteAtComm:input_type -> remotefscomms.ContentMsg
	2,  // 19: remotefscomms.RemoteFSComms.ReadAtComm:input_type -> remotefscomms.ContentMsg
	1,  // 20: remotefscomms.RemoteFSComms.GetSizeComm:output_type -> remotefscomms.UintMsg
	1,  // 21: remotefscomms.RemoteFSComms.GetLengthComm:output_type -> remotefscomms.UintMsg
	0,  // 22: remotefscomms.RemoteFSComms.GetInfoComm:output_type -> remotefscomms.FileInfoMsg
	5,  // 23: remotefscomms.RemoteFSComms.SetInfoComm:output_type -> remotefscomms.Empty
	5,  // 24: remotefscomms.RemoteFSComms.DeleteComm:output_type -> remotefscomms.Empty
	1,  // 25: remotefscomms.RemoteFSComms.MkDirComm:output_type -> remotefscomms.UintMsg
	1,  // 26: remotefscomms.RemoteFSComms.GenerateHandleComm:output_type -> remotefscomms.UintMsg
	1,  // 27: remotefscomms.RemoteFSComms.CreateFileComm:output_type -> remotefscomms.UintMsg
	5,  // 28: remotefscomms.RemoteFSComms.RmDirComm:output_type -> remotefscomms.Empty
	5,  // 29: remotefscomms.RemoteFSComms.DeleteHandleComm:output_type -> remotefscomms.Empty
	5,  // 30: remotefscomms.RemoteFSComms.SyncFileComm:output_type -> remotefscomms.Empty
	1,  // 31: remotefscomms.RemoteFSComms.WriteAtComm:output_type -> remotefscomms.UintMsg
	1,  // 32: remotefscomms.RemoteFSComms.ReadAtComm:output_type -> remotefscomms.UintMsg
